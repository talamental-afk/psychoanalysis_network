...
,
  // 温尼科特概念之间的关系
  { source: 'holding_environment', target: 'transitional_object', type: 'relates', strength: 0.9 },
  { source: 'holding_environment', target: 'true_self', type: 'influences', strength: 0.9 },
  { source: 'true_self', target: 'false_self', type: 'relates', strength: 1 },
  { source: 'false_self', target: 'defense_mechanisms', type: 'relates', strength: 0.8 },
  ...
  { source: 'alpha_function', target: 'beta_elements', type: 'relates', strength: 1 },
  { source: 'reverie', target: 'container_contained', type: 'relates', strength: 0.9 },
  { source: 'reverie', target: 'empathy', type: 'relates', strength: 0.8 },
  { source: 'container_contained', target: 'projective_identification', type: 'relates', strength: 0.9 },
  ...
  { source: 'libidinal_object', target: 'exciting_object', type: 'relates', strength: 0.8 },
  { source: 'exciting_object', target: 'rejecting_object', type: 'relates', strength: 0.9 },
  { source: 'internal_objects', target: 'object_relations', type: 'manifests', strength: 0.9 },
  { source: 'internal_objects', target: 'introjection', type: 'relates', strength: 0.8 },
